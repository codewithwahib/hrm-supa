...
interface EmployeeFormData {
  personalDetails: {
    ...
    department: string
    position: string
    source: 'K' | 'PQ'  // ✅ New field for branch
    enableSiteVisits: boolean  // ✅ New field
    enableAttendance: boolean  // ✅ New field
  }
  qualifications: Qualification[]
  experience: Experience[]
  username: string
...
export default function AddEmployeePage() {
  ...
  const [formData, setFormData] = useState<EmployeeFormData>({
    personalDetails: {
      ...
      department: '',
      position: '',
      source: 'K',  // Default to Korangi
      enableSiteVisits: true,  // Default enabled
      enableAttendance: true   // Default enabled
    },
    qualifications: [],
    experience: [],
    username: '',
              ...
              {currentSection === 1 && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* ✅ Enable Site Visits & Enable Attendance - New Toggle Options */}
                    <div className="md:col-span-2">
